...
{title: `${emot} ☭ Anime`, rowId: ".? anime", description: "Yahahah Wibu"},
{title: `${emot} 𓂸 ︎Nsfw`, rowId: ".? nsfw", description: "Dasar Sang*"},
{title: `${emot} ☭ Premium`, rowId: ".? premium", description: "Only premium Users"},
{title: `${emot} ☭ Chats`, rowId: ".? anonymous", description: "Bicara dengan orang tidak dikenal"},
{title: `${emot} ☏ Al-Quran`, rowId: ".? quran", description: "Mantep Tobat Juga"},
...
{title: `${emot} ✎ Nulis`, rowId: ".? nulis", description: "Males Amat Nulis Lu"},
